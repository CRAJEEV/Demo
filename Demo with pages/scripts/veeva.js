    ...
    trackSlideVisit: function (callback) {
        ...
        switch (app.veeva.environment()) {
            case 'pdi':
                ...
                break;
            default:
                this.saveClickstreamObject({ Track_Element_Id_vod__c: app.slides.currentSlide.guid, Track_Element_Description_vod__c: app.slides.currentSlide.isChild ? "ChildSlide" : "ParentSlide", Popup_Opened_vod__c: !!app.slides.currentSlide.isChild }, callback);
        }
    }
}
